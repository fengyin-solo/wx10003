<template>
  <section class="page" data-module="maintenance">
    <header class="page-head">
      <div>
        <h2>养护计划管理</h2>
        <p class="page-desc">维护养护计划，围绕计划编号、养护管段、养护类型、计划日期做登记、筛选与状态流转。</p>
      </div>
...
const columns = ["计划编号", "养护管段", "养护类型", "计划日期", "养护班组", "工程预算", "验收日期", "计划状态"]
const actions = ["批准计划", "下达施工", "组织验收"]
const statuses = ["待批准", "已下达", "施工中", "待验收", "已完工"]
const stats = [{"label": "待批准计划", "value": 0}, {"label": "施工中计划", "value": 0}, {"label": "待验收计划", "value": 0}]
